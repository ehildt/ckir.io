...
```ini
# A collection of utility functions and constants used in main.ts and shared across the monorepo.
- bootstrap

# Splits text into sentences and provides a chainable API to append more text.
...
# (Optional) IF APP_CONFIG SHOULD BE PRINTED
PRINT_CONFIG=true
