...
BULLMQ_QUEUE_BROADCAST_MESSAGE=BROADCAST_MESSAGE
BULLMQ_QUEUE_VECTORIZE_MESSAGE=VECTORIZE_MESSAGE
BULLMQ_QUEUE_PERSIST_TOPIC=PERSIST_TOPIC
BULLMQ_QUEUE_BROADCAST_TOPIC=BROADCAST_TOPIC
BULLMQ_QUEUE_VECTORIZE_TOPIC=VECTORIZE_TOPIC
BULLMQ_QUEUE_PERSIST_THREAD=PERSIST_THREAD
BULLMQ_QUEUE_BROADCAST_THREAD=BROADCAST_THREAD
BULLMQ_QUEUE_VECTORIZE_THREAD=VECTORIZE_THREAD
```
