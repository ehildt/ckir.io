...
/**
 * Represents a request to apply an emoji reaction to a message. \
...
export class MessageEmojiReq {
  /**
   * The label of the emoji reaction applied to this message. \
  ...
  @ApiProperty({
    default: 'laugh',
    required: true,
    description: 'The label of the emoji reaction applied to this message.',
  })
  label: string;
