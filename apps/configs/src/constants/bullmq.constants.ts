...
export const BULLMQ_QUEUE = Object.freeze({
  ...
  BROADCAST_TOPIC: process.env.BULLMQ_QUEUE_BROADCAST_TOPIC ?? BULLMQ_DEFAULT.BROADCAST_TOPIC,
  BROADCAST_THREAD: process.env.BULLMQ_QUEUE_BROADCAST_THREAD ?? BULLMQ_DEFAULT.BROADCAST_THREAD,
  BROADCAST_MESSAGE: process.env.BULLMQ_QUEUE_BROADCAST_MESSAGE ?? BULLMQ_DEFAULT.BROADCAST_MESSAGE,
  VECTORIZE_TOPIC: process.env.BULLMQ_QUEUE_VECTORIZE_TOPIC ?? BULLMQ_DEFAULT.VECTORIZE_TOPIC,
  VECTORIZE_THREAD: process.env.BULLMQ_QUEUE_VECTORIZE_THREAD ?? BULLMQ_DEFAULT.VECTORIZE_THREAD,
