...
export const BullMQConfigArgsSchema = Joi.object<BullMQArgs>({
  ...
  queueBroadcastThread: Joi.string().min(1).optional(),
  queueVectorizeThread: Joi.string().min(1).optional(),
});
...
export function BullMQConfigArgsAdapter(): BullMQArgs {
  return {
    ...
    jobDispatch: process.env.BULLMQ_JOB_MESSAGE ?? BULLMQ_JOB.MESSAGE,
    queuePersistMessage: process.env.BULLMQ_QUEUE_PERSIST_MESSAGE ?? BULLMQ_QUEUE.PERSIST_MESSAGE,
    queueBroadcastMessage: process.env.BULLMQ_QUEUE_BROADCAST_MESSAGE ?? BULLMQ_QUEUE.BROADCAST_MESSAGE,
    queueVectorizeMessage: process.env.BULLMQ_QUEUE_VECTORIZE_MESSAGE ?? BULLMQ_QUEUE.VECTORIZE_MESSAGE,
    queuePersistTopic: process.env.BULLMQ_QUEUE_PERSIST_TOPIC ?? BULLMQ_QUEUE.PERSIST_TOPIC,
    queueBroadcastTopic: process.env.BULLMQ_QUEUE_BROADCAST_TOPIC ?? BULLMQ_QUEUE.BROADCAST_TOPIC,
    queueVectorizeTopic: process.env.BULLMQ_QUEUE_VECTORIZE_TOPIC ?? BULLMQ_QUEUE.VECTORIZE_TOPIC,
    queuePersistThread: process.env.BULLMQ_QUEUE_PERSIST_THREAD ?? BULLMQ_QUEUE.PERSIST_THREAD,
    queueBroadcastThread: process.env.BULLMQ_QUEUE_BROADCAST_THREAD ?? BULLMQ_QUEUE.BROADCAST_THREAD,
    queueVectorizeThread: process.env.BULLMQ_QUEUE_VECTORIZE_THREAD ?? BULLMQ_QUEUE.VECTORIZE_THREAD,
  };
}
