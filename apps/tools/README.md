**@CKIR.IO/CHATS** is a lightweight microservice that performs AI model inference. It provides a streamlined API for running predictions on deployed machine-learning models, handling input preprocessing, model execution, and output post-processing. The service is designed for scalability, low-latency inference, and easy integration into larger distributed systems.
